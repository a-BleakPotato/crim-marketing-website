...
export default function HeroSection({ school }: HeroSectionProps) {
  ...
  if (variant === 'split-right') {
    return (
      ...
      {/* Content */}
      <div className="relative z-10 flex items-center min-h-[90vh] w-full px-8 sm:px-12 lg:px-16 text-content">
        <motion.div
        ...
        >
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight mb-5 text-content-inverted">
            {school.school.name}
          </h1>

          <p className="text-lg sm:text-xl text-content-inverted mb-4 font-light">
            {school.school.tagline}
          </p>

          <p className="text-content-inverted text-base max-w-xl mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              ...
              className="px-8 py-3.5 rounded-full font-semibold border-2 hover:bg-black/5 transition-colors text-sm text-center"
              style={{
                color: accent,
